...
pacman --noconfirm -Syu boost gnutls gst-plugin-base lttng-ust meson ninja openssl python-jinja python-ply python-yaml sed gtest doxygen graphviz libevent libtiff python-sphinx
